...
const TRANSLATIONS = {
  en: {
    ...
    "aggregator.title": "Market Intelligence", "aggregator.subtitle": "Aggregator",
    "aggregator.add_account": "Add Account", "aggregator.tracked_accounts": "Tracked Accounts",
    "aggregator.generate_insights": "Generate AI Insights", "aggregator.ai_strategy": "CLAUDE STRATEGY",
    "aggregator.post_ideas": "POST IDEAS", "aggregator.market_trends": "Market Trends",
    "aggregator.feed_title": "Competitive Feed", "aggregator.type_owned": "owned",
    "aggregator.type_competitor": "competitor", "aggregator.type_owned_full": "Owned Account",
    "aggregator.type_competitor_full": "Competitor Account", "aggregator.account_type": "Account Type",
    "aggregator.synced": "Synced", "aggregator.syncing": "Pending",
    "aggregator.no_accounts": "No accounts yet. Add one to get started.",
    "aggregator.sync_pending_banner": "Syncing posts in background — this takes ~30 seconds",
  ...
  hi: {
    ...
    "aggregator.title": "\u092e\u093e\u0930\u094d\u0915\u0947\u091f \u0907\u0902\u091f\u0947\u0932\u093f\u091c\u0947\u0902\u0938", "aggregator.subtitle": "\u090f\u0917\u094d\u0930\u0940\u0917\u0947\u091f\u0930",
    "aggregator.add_account": "\u0916\u093e\u0924\u093e \u091c\u094b\u0921\u093c\u0947\u0902", "aggregator.tracked_accounts": "\u091f\u094d\u0930\u0948\u0915 \u0915\u093f\u090f \u0917\u090f \u0916\u093e\u0924\u0947",
    "aggregator.generate_insights": "AI Insights \u091c\u0928\u0930\u0947\u091f \u0915\u0930\u0947\u0902", "aggregator.ai_strategy": "CLAUDE \u0930\u0923\u0928\u0940\u0924\u093f",
    dashboard: "डैशबोर्ड", create: "पोस्ट बनाएं", posts: "मेरे पोस्ट",
    ...
    "aggregator.add_account": "खाता जोड़ें", "aggregator.tracked_accounts": "ट्रैक किए गए खाते",
    "aggregator.generate_insights": "AI Insights जनरेट करें", "aggregator.ai_strategy": "CLAUDE रणनीति",
    "aggregator.post_ideas": "पोस्ट विचार", "aggregator.market_trends": "मार्केट ट्रेंड्स",
    "aggregator.feed_title": "कॉम्पिटिटिव फीड", "aggregator.type_owned": "निजी",
    "aggregator.type_competitor": "प्रतिद्वंद्वी", "aggregator.type_owned_full": "निजी खाता",
    "aggregator.type_competitor_full": "प्रतिद्वंद्वी खाता", "aggregator.account_type": "खाते का प्रकार",
    "aggregator.synced": "सिंक हुआ", "aggregator.syncing": "लंबित",
  ...
  te: {
    ...
    "aggregator.title": "మార్కెట్ ఇంటెలిజెన్స్", "aggregator.subtitle": "అగ్రిగేటర్",
    "aggregator.add_account": "ఖాతాను జోడించండి", "aggregator.tracked_accounts": "ట్రాక్ చేయబడిన ఖాతాలు",
    "aggregator.generate_insights": "AI Insights సృష్టించండి", "aggregator.ai_strategy": "CLAUDE వ్యూహం",
    "aggregator.post_ideas": "పోస్ట్ ఆలోచనలు", "aggregator.market_trends": "మార్కెట్ ట్రెండ్స్",
    "aggregator.feed_title": "కాంపిటిటివ్ ఫీడ్", "aggregator.type_owned": "స్వంత",
    "aggregator.type_competitor": "పోటీదారు", "aggregator.type_owned_full": "స్వంత ఖాతా",
    "aggregator.type_competitor_full": "పోటీదారి ఖాతా", "aggregator.account_type": "ఖాతా రకం",
    "aggregator.synced": "సింక్ అయింది", "aggregator.syncing": "పెండింగ్",
  ...
  ta: {
    ...
    "aggregator.title": "சந்தை நுண்ணறிவு", "aggregator.subtitle": "அகிரிகேட்டர்",
    "aggregator.add_account": "கணக்கைச் சேர்", "aggregator.tracked_accounts": "கண்காணிக்கப்படும் கணக்குகள்",
    "aggregator.generate_insights": "AI Insights உருவாக்கு", "aggregator.ai_strategy": "CLAUDE வயூகம்",
    "aggregator.post_ideas": "போஸ்ட் சிந்தனைகள்", "aggregator.market_trends": "சந்தை யுக்திகள்",
    "aggregator.feed_title": "போட்டி பீட்", "aggregator.type_owned": "சொந்த",
    "aggregator.type_competitor": "போட்டியாளர்", "aggregator.type_owned_full": "சொந்த கணக்கு",
    "aggregator.type_competitor_full": "போட்டியாளர் கணக்கு", "aggregator.account_type": "கணக்கு வகை",
    "aggregator.synced": "சிங்க் செய்யப்பட்டது", "aggregator.syncing": "நிலுவை",
  ...
  kn: {
    ...
    "aggregator.title": "ಮಾರುಕಟ್ಟೆ ಬುದ್ಧಿವಂತಿಕೆ", "aggregator.subtitle": "ಅಗ್ರಿವೇಟರ್",
    "aggregator.add_account": "ಖಾತೆಯನ್ನು ಸೇರಿಸಿ", "aggregator.tracked_accounts": "ಟ್ರ್ಯಾಕ್ ಮಾಡಲಾದ ಖಾತೆಗಳು",
    "aggregator.generate_insights": "AI Insights ಮಾಡಿ", "aggregator.ai_strategy": "CLAUDE ಯುಕ್ತಿ",
    "aggregator.post_ideas": "ಪೋಸ್ಟ್ ಐಡಿಯಾಗಳು", "aggregator.market_trends": "ಮಾರುಕಟ್ಟೆ ಪ್ರವೃತ್ತಿಗಳು",
    "aggregator.feed_title": "ಸ್ಪರ್ಧಾತ್ಮಕ ಫೀಡ್", "aggregator.type_owned": "ಸ್ವಂತ",
    "aggregator.type_competitor": "ಸ್ಪರ್ಧಿ", "aggregator.type_owned_full": "ಸ್ವಂತ ಖಾತೆ",
    "aggregator.type_competitor_full": "ಸ್ಪರ್ಧಿಯ ಖಾತೆ", "aggregator.account_type": "ಖಾತೆ ವಿಧ",
    "aggregator.synced": "ಸಿಂಕ್ ಆಗಿದೆ", "aggregator.syncing": "ಬಾಕಿ",
  ...
  mr: {
    ...
    "aggregator.title": "\u092e\u093e\u0930\u094d\u0915\u0947\u091f \u0907\u0902\u091f\u0947\u0932\u093f\u091c\u0947\u0902\u0938", "aggregator.subtitle": "\u090d\u0917\u094d\u0930\u0940\u0917\u0947\u091f\u0930",
    "aggregator.add_account": "\u0916\u093e\u0924\u0947 \u091c\u094b\u0921\u093e", "aggregator.tracked_accounts": "\u091f\u094d\u0930\u0945\u0915 \u0915\u0947\u0932\u0947\u0932\u0947 \u0916\u093e\u0924\u0947",
    "aggregator.generate_insights": "AI Insights \u0924\u092f\u093e\u0930 \u0915\u0930\u093e", "aggregator.ai_strategy": "CLAUDE \u0935\u094d\u092f\u0942\u0939",
    "aggregator.post_ideas": "\u092a\u094b\u0938\u094d\u091f \u0906\u092f\u0921\u093f\u092f\u093e", "aggregator.market_trends": "\u092e\u093e\u0930\u094d\u0915\u0947\u091f \u091f\u094d\u0930\u0947\u0902\u0921\u094d\u0938",
    "aggregator.feed_title": "\u0938\u094d\u092a\u0930\u094d\u0927\u093e\u0924\u094d\u092e\u0915 \u092b\u0940\u0921", "aggregator.type_owned": "\u0938\u094d\u0935\u0924\u0903\u091a\u0947",
    "aggregator.type_competitor": "\u0938\u094d\u092a\u0930\u094d\u0927\u0915", "aggregator.type_owned_full": "\u0938\u094d\u0935\u0924\u0903\u091a\u0947 \u0916\u093e\u0924\u0947",
    "aggregator.type_competitor_full": "\u0938\u094d\u092a\u0930\u094d\u0927\u0915\u093e\u091a\u0947 \u0916\u093e\u0924\u0947", "aggregator.account_type": "\u0916\u093e\u0924\u094d\u092f\u093e\u091a\u093e \u092a\u094d\u0930\u0915\u093e\u0930",
    "aggregator.synced": "\u0938\u093f\u0902\u0915 \u091d\u093e\u0932\u0947", "aggregator.syncing": "\u092a\u0947\u0902\u0921\u093f\u0902\u0917",
    "aggregator.no_accounts": "\u0905\u092d\u094d\u092f\u093e\u0938 \u0915\u0930\u0923\u094d\u092f\u093e\u0938\u093e\u0920\u0940 \u0915\u094b\u0923\u0924\u0947\u0939\u0940 \u0916\u093e\u0924\u0947 \u0928\u093e\u0939\u0940\u0924\u0961 \u0938\u0941\u0930\u0941 \u0915\u0930\u0923\u094d\u092f\u093e\u0938\u093e\u0920\u0940 \u090f\u0915 \u091c\u094b\u0921\u093e\u0961",
    "aggregator.sync_pending_banner": "\u092c\u0945\u0915\u0917\u094d\u0930\u093e\u0909\u0902\u0921\u092e\u0927\u094d\u092f\u0947 \u092a\u094b\u0938\u094d\u091f \u0938\u093f\u0902\u0915 \u0939\u094b\u0924 \u0906\u0939\u0947\u0924 - \u092f\u093e\u0932\u093e ~30 \u0938\u0947\u0915\u0902\u0926 \u0932\u093e\u0917\u0924\u0940\u0932",
    "aggregator.account_added_msg": "\u0916\u093e\u0924\u0947 \u091c\u094b\u0921\u0932\u0947 \u0917\u0947\u0932\u0947 \u0906\u0939\u0947! \u0921\u0947\u091f\u093e \u0932\u0935\u0915\u0930\u091a \u0938\u093f\u0902\u0915 \u0939\u094b\u0908\u0932\u0961",
